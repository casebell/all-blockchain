...
class CoinisGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Coinis entity")
        ...
        .repeat(2) {
            ...
            .post("/api/coinis")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "closeprice":"SAMPLE_TEXT", "highprice":"SAMPLE_TEXT", "itemcode":"SAMPLE_TEXT", "lowprice":"SAMPLE_TEXT", "openprice":"SAMPLE_TEXT", "prevcloseprice":"SAMPLE_TEXT", "tradeamount":"SAMPLE_TEXT", "tradedaebi":"SAMPLE_TEXT", "tradedaebirate":"SAMPLE_TEXT", "tradedate":"SAMPLE_TEXT", "tradevolumn":"SAMPLE_TEXT", "symbol":"SAMPLE_TEXT", "createdat":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
