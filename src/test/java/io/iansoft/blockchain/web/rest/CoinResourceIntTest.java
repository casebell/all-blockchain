...
public class CoinResourceIntTest {
    ...
    public void createCoin() throws Exception {
        ...
        assertThat(testCoin.getReleaseat()).isEqualTo(testCoin.getReleaseat());
        assertThat(testCoin.getCreatedat()).isEqualTo(testCoin.getCreatedat());
        assertThat(testCoin.getUpdatedat()).isEqualTo(testCoin.getUpdatedat());
        assertThat(coinEs).isEqualToIgnoringGivenFields(testCoin, "releaseat", "createdat", "updatedat");
    }
