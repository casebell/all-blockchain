...
public class CoinisResourceIntTest {
    ...
    public void setup() {
        ...
        final CoinisResource coinisResource = new CoinisResource(coinisService);
    ...
    public void createCoinis() throws Exception {
        ...
        assertThat(testCoinis.getCreatedat()).isEqualTo(testCoinis.getCreatedat());
        assertThat(coinisEs).isEqualToIgnoringGivenFields(testCoinis, "createdat");
    }
    ...
    public void updateCoinis() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCoinis are not directly saved in db
        em.detach(updatedCoinis);
        updatedCoinis
