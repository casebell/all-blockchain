...
public class KrakenResourceIntTest {
    ...
    private static final String UPDATED_SYMBOL = "ETH";
    ...
    public void createKraken() throws Exception {
        ...
        assertThat(testKraken.getSymbol()).isEqualTo(DEFAULT_SYMBOL);
        ...
        assertThat(krakenEs).isEqualToComparingFieldByField(testKraken);
    }
    ...
    public void updateKraken() throws Exception {
        ...
        assertThat(testKraken.getSymbol()).isEqualTo(UPDATED_SYMBOL);
