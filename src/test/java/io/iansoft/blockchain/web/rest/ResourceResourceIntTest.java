...
public class ResourceResourceIntTest {
    ...
    public void createResource() throws Exception {
        ...
        assertThat(testResource.getCreatedAt()).isEqualTo(testResource.getCreatedAt());
        assertThat(testResource.getUpdatedAt()).isEqualTo(testResource.getUpdatedAt());
        assertThat(resourceEs).isEqualToIgnoringGivenFields(testResource, "createdAt", "updatedAt");
    }
