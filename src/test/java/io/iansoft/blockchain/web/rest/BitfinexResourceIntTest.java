...
public class BitfinexResourceIntTest {
    ...
    public void createBitfinex() throws Exception {
        ...
        assertThat(bitfinexEs).isEqualToIgnoringGivenFields(testBitfinex);
    }
    ...
    public void updateBitfinex() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedBitfinex are not directly saved in db
        em.detach(updatedBitfinex);
        updatedBitfinex
            .mid(UPDATED_MID)
            .bid(UPDATED_BID)
            .ask(UPDATED_ASK)
