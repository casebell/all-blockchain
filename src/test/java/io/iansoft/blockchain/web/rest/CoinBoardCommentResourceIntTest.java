...
public class CoinBoardCommentResourceIntTest {
    ...
    public void setup() {
        ...
        final CoinBoardCommentResource coinBoardCommentResource = new CoinBoardCommentResource(coinBoardCommentService);
    ...
    public void createCoinBoardComment() throws Exception {
        ...
        assertThat(testCoinBoardComment.getCreatedat()).isEqualTo(testCoinBoardComment.getCreatedat());
        assertThat(testCoinBoardComment.getUpdatedat()).isEqualTo(testCoinBoardComment.getUpdatedat());
        assertThat(coinBoardCommentEs).isEqualToIgnoringGivenFields(testCoinBoardComment, "createdat", "updatedat");
    }
    ...
    public void updateCoinBoardComment() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCoinBoardComment are not directly saved in db
        em.detach(updatedCoinBoardComment);
