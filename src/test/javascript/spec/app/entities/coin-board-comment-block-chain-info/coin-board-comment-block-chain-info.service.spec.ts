...
describe('Service Tests', () => {
    ...
    describe('CoinBoardCommentBlockChainInfo Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CoinBoardCommentBlockChainInfoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/coin-board-comments/' + 123);
            });
            it('should return CoinBoardCommentBlockChainInfo', () => {

                let entity: CoinBoardCommentBlockChainInfo;
                service.find(123).subscribe((_entity: CoinBoardCommentBlockChainInfo) => {
                    entity = _entity;
                });
