...
import { CoinBoardCommentBlockChainInfoComponent } from '../../../../../../main/webapp/app/entities/coin-board-comment-block-chain-info/coin-board-comment-block-chain-info.component';
        ...
        describe('OnInit', () => {
            it('Should call load all on init', () => {
                ...
                spyOn(service, 'query').and.returnValue(Observable.of({
                    json: [new CoinBoardCommentBlockChainInfo(123)],
                    headers
                }));
