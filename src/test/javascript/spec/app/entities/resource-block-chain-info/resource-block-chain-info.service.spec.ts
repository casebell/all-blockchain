...
describe('Service Tests', () => {
    ...
    describe('ResourceBlockChainInfo Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ResourceBlockChainInfoService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ResourceBlockChainInfo', () => {

                let entity: ResourceBlockChainInfo;
                service.find(123).subscribe((_entity: ResourceBlockChainInfo) => {
                    entity = _entity;
                });
