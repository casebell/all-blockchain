...
public class CoinBoardCommentResource {
    ...
    public ResponseEntity<CoinBoardCommentDTO> createCoinBoardComment(@RequestBody CoinBoardCommentDTO coinBoardCommentDTO) throws URISyntaxException {
        ...
        if (coinBoardCommentDTO.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new coinBoardComment cannot already have an ID")).body(null);
        }
    ...
    @Timed
    public ResponseEntity<List<CoinBoardCommentDTO>> getAllCoinBoardComments(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<CoinBoardCommentDTO>> searchCoinBoardComments(@RequestParam String query, @ApiParam Pageable pageable) {
