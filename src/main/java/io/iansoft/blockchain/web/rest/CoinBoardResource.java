...
public class CoinBoardResource {
    ...
    public ResponseEntity<CoinBoardDTO> createCoinBoard(@RequestBody CoinBoardDTO coinBoardDTO) throws URISyntaxException {
        ...
        if (coinBoardDTO.getId() != null) {
            throw new BadRequestAlertException("A new coinBoard cannot already have an ID", ENTITY_NAME, "idexists");
        }
    ...
    @Timed
    public ResponseEntity<List<CoinBoardDTO>> getAllCoinBoards(Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<CoinBoardDTO>> searchCoinBoards(@RequestParam String query, Pageable pageable) {
