package io.iansoft.blockchain.config;
...
@Configuration
@EnableJpaRepositories("io.iansoft.blockchain.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.iansoft.blockchain.repository.search")
