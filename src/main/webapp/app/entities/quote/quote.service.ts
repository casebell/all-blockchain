...
export class QuoteService {
     ...
     */
    private convertItemFromServer(json: any): Quote {
        const entity: Quote = Object.assign(new Quote(), json);
        entity.quoteTime = this.dateUtils
            .convertDateTimeFromServer(json.quoteTime);
        return entity;
    }
