...
export class CoinisService {
    ...
    create(coinis: Coinis): Observable<Coinis> {
    ...
    update(coinis: Coinis): Observable<Coinis> {
        const copy = this.convert(coinis);
    ...
    find(id: number): Observable<Coinis> {
     ...
     */
    private convertItemFromServer(json: any): Coinis {
        const entity: Coinis = Object.assign(new Coinis(), json);
